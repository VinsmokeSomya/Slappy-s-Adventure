...
public class LevelSelectFrame : MonoBehaviour {
    ...
    public LevelStatsDialog levelStatsDialog;
    ...
    private void Start() {
        ...
        levelInfoButton.onClick.AddListener(BuildLevelStats);
    ...
    public void SetLevel(Level level) {
        ...
        currentid = level.id;
        currentIsLocked = level.IsLocked(levels);
    ...
    public void StartLevel(Level level) {
        if (level == null || level.IsLocked(levels)) return;//double-check
    ...
    private void BuildLevelStats() {
        levelStatsDialog.gameObject.SetActive(true);
        levelStatsDialog.Build(GetCurrentLevel());
    }
}
